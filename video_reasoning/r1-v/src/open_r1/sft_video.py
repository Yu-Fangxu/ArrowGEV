...
# wandb.login(key="d211858b28b24ac185e3633c24e932b9e58d53e9")
...
def prepare_dataset(example: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    # video_path = os.path.abspath(os.path.join("/mnt/gemininjceph3/geminicephfs/pr-others-prctrans/fangxuyu/Video-R1/src/Video-R1-data", example['path'].lstrip('/')))
...
if __name__ == "__main__":
    ...
    training_args.report_to = "none"  # Disable wandb logging
