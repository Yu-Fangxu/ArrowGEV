...
# for dataset_name in ['mvbench']:

    OUTPUT_PATH = f"/mnt/gemininjceph3/geminicephfs/pr-others-prctrans/fangxuyu/Video-R1/src/r1-v/eval_results/eval_{dataset_name}_{file_name}_greedy_output.json"
    PROMPT_PATH = f"/mnt/gemininjceph3/geminicephfs/pr-others-prctrans/fangxuyu/Video-R1/src/r1-v/Evaluation/eval_{dataset_name}.json"
